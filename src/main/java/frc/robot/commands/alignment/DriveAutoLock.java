...
public class DriveAutoLock extends Command {
   ...
   */
  public DriveAutoLock(CommandSwerveDrivetrain drivetrain, DoubleSupplier getLeftY, DoubleSupplier getLeftX, DoubleSupplier getRightX) {
