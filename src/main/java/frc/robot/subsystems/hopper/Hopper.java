...
public class Hopper extends SubsystemBase {
	...
	public void initSendable(SendableBuilder builder) {
		...
		builder.addDoubleProperty("Dashboard RPM", () -> dashboardFloorTargetRPM, value -> dashboardFloorTargetRPM = value);
		builder.addDoubleProperty("Dashboard RPM", () -> dashboardFloorTargetRPM, value -> dashboardFloorTargetRPM = value);
	
        builder.addDoubleProperty("Target RPM", () -> FeedervelocityRequest.getVelocityMeasure().in(RPM), null);
		builder.addDoubleProperty("Target RPM", () -> FloorvelocityRequest.getVelocityMeasure().in(RPM), null);
